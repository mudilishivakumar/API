...
public class TC001_Get_All_Accounts extends TestBase{

		
	@BeforeClass
	void getAllAccounts() throws InterruptedException
	{
	
	logger.info("*********Started TC001_Get_All_Accounts **********");
		
	RestAssured.baseURI = "https://ig.aidtaas.com/market-place/v1.0";
	httpsRequest = RestAssured.given();
	response = httpsRequest.request(Method.GET,"/accounts");
	...
	void tearDown()
	{
		logger.info("*********  Finished TC001_Get_All_Accounts **********");
	}
